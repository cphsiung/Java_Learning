   ...
   public static void main(String[] args)
      
      {
         ...
         for (int k = 0; k < size; k++) {
            ...
            if (hours[k] > 40) {
               overtime[k] = (hours[k] - 40) * rate[k] * overtimeRate;
            } else {
               overtime[k] = 0;
            }
            // Calculate gross pay
            grossPay[k] = rates[k] * hours[k] + overtime[k];
         ...
         System.out.println("                   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
         System.out.printf("%-12s %-3s %-12s %8s %8s %8s %8s %8s %8s %8s\n", 
         ...
         for (int j = 0; j < size; j++) {
            ...
            System.out.printf("%$9.2f", rates[j]);
            System.out.printf("%9.0f", hours[j]);
            System.out.printf("%$9.2f", Gross[j]);
            System.out.printf("%$9.2f", stateTax[j]);
            System.out.printf("%$9.2f", fedTax[j]);
            System.out.printf("%$9.2f", unionFee[j]);
